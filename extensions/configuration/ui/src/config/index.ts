...
export const meta = {
  title: 'Configuration',
  description: 'The configuration of a Toa application',
} as const
 ...
 * there is no ingress and the two are separate ports: the values service serves this
 * page, the gateway answers next door.
 */
export const origin = (() => {
