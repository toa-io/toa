...
export interface Component {
  ...
  register: (request: { input: RegisterInput, task?: boolean }, options?: Options) => Promise<RegisterOutput>
  describe: (request: { input: DescribeInput, task?: boolean }, options?: Options) => Promise<DescribeOutput | RemoteError<"UNKNOWN_CLIENT">>
