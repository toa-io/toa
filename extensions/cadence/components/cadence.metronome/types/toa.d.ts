...
export interface Component {
  delay: (request: { input: DelayInput, task?: boolean }, options?: Options) => Promise<DelayOutput>
  settle: (request: { input?: null, query: Query<Entity>, task?: boolean }, options?: Options) => Promise<unknown>
