...
class Connector {
    ...
    async connect() {
        ...
        console.log(`Connected to ${this._url} (${this._location.db}.${this._location.collection})`);
    }

    async disconnect() {
        await this._client.close();

        console.log(`Disconnected form ${this._url} (${this._location.db}.${this._location.collection})`);
    }
